...
const PreviewPage = ({ profileImage, name, surname, email, links, setIsPreviewShown }: Props) => {
  ...
  return (
    ...
    <div className="preview-page-header-wrapper">
      ...
      <div className="preview-page-header">
        ...
        <CustomButton text="Back to editor" type="secondary" onClick={() => setIsPreviewShown(false)} width="fit-content"/>
      </div>
    </div>
